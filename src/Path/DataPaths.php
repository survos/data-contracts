...
namespace Survos\DataContracts\Path;
 ...
 */
/*
 * Not final: Survos\DatasetBundle\Service\DataPaths is a deprecated BC subclass of this class,
 * kept because `instanceof` and parameter type checks do not autoload, so a class_alias would only
 * work once something had happened to load it. Nothing else should extend this.
 */
class DataPaths
{
